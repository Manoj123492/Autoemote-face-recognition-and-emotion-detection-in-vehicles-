...
global yawn_count_threshold, yawn_count, eye_count_threshold, eye_count


yawn_count_threshold = 50  
yawn_count = 0
eye_count_threshold = 50
eye_count = 0


main = tkinter.Tk()
main.title("Driver Monitoring")
        ...
        for rect in rects:
            ...
            if ear < EYE_AR_THRESH:
                ...
                if COUNTER >= EYE_AR_CONSEC_FRAMES:
                    ...
                    eye_count += 1
                    if eye_count >= eye_count_threshold:
                        playsound('alarm.mp3')  
                        eye_count = 0
            else:
                COUNTER = 0
...
font = ('times', 16, 'bold')
title = Label(main, text='  AUTOEMOTE: INTEGRATING FACE RECOGNITION \n AND EMOTION DETECTION IN VEHICLES',anchor=W, justify=LEFT)
